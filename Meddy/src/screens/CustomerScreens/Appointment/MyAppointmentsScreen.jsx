  ...
  useFocusEffect(
    useCallback(() => {
      const fetchAppointments = async () => {
        try {
          const response = await fetchWithAuth(`appointment/booked-appointments/`, {
            method: "GET",
          });
        ...
        >
          {appointments.length === 0 ? (
            <View style={styles.noAppointmentsContainer}>
              <Text category="h6" appearance="hint">No appointments found</Text>
            </View>
          ) : (
              ...
              {appointments.map((appointment, index) => (
                ...
                >
                  ...
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      navigation.navigate("My Appointment Details", { 
                        "hideTabBar": true, 
                        appointment
                      });
                    }}
